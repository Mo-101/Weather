  ...
  useEffect(() => {
    if (typeof window !== "undefined" && window.Cesium && cesiumContainerRef.current) {
      ...
      viewerRef.current.camera.setView({
        destination: window.Cesium.Cartesian3.fromDegrees(8.6753, 9.082, 1000000),
        orientation: {
          heading: 0.0,
          pitch: -0.5,
          roll: 0.0,
      ...
      // Add weather stations for major Nigerian cities
      const cities = [
  ...
  return (
    <>
      ...
      <link
        ...
        rel="stylesheet"
      />
      <div ref={cesiumContainerRef} className="w-full h-full" style={{ background: "transparent" }} />
    </>
  )
}
